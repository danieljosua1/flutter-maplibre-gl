...
abstract class MapLibrePlatform {
  ...
  static MapLibrePlatform Function() createInstance = () => _instance ?? MapLibreMethodChannel();
  ...
  Future<void> addLayerBelow(
      String imageLayerId, String imageSourceId, String belowLayerId, double? minzoom, double? maxzoom);
  ...
  Future<void> addRasterLayer(String sourceId, String layerId, Map<String, dynamic> properties,
      {String? belowLayerId, String? sourceLayer, double? minzoom, double? maxzoom});
