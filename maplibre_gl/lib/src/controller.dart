...
typedef OnFeatureInteractionCallback = void Function(dynamic id, Point<double> point, LatLng coordinates);
...
class MapLibreMapController extends ChangeNotifier {
  ...
  Future<void> addGeoJsonSource(String sourceId, Map<String, dynamic> geojson, {String? promoteId}) async {
    await _maplibrePlatform.addGeoJsonSource(sourceId, geojson, promoteId: promoteId);
  }
  ...
  Future<void> setGeoJsonFeature(String sourceId, Map<String, dynamic> geojsonFeature) async {
    await _maplibrePlatform.setFeatureForGeoJsonSource(sourceId, geojsonFeature);
  }
  ...
  Future<void> updateMyLocationTrackingMode(MyLocationTrackingMode myLocationTrackingMode) async {
    return _maplibrePlatform.updateMyLocationTrackingMode(myLocationTrackingMode);
  }
  ...
  Future<List> queryRenderedFeaturesInRect(Rect rect, List<String> layerIds, String? filter) async {
    return _maplibrePlatform.queryRenderedFeaturesInRect(rect, layerIds, filter);
  }
  ...
  Future<List> querySourceFeatures(String sourceId, String? sourceLayerId, List<Object>? filter) async {
    return _maplibrePlatform.querySourceFeatures(sourceId, sourceLayerId, filter);
  }
  ...
  Future<void> updateImageSource(String imageSourceId, Uint8List? bytes, LatLngQuad? coordinates) {
    return _maplibrePlatform.updateImageSource(imageSourceId, bytes, coordinates);
  }
  ...
  Future<void> addImageLayerBelow(String layerId, String sourceId, String imageSourceId,
    ...
    return _maplibrePlatform.addLayerBelow(layerId, sourceId, imageSourceId, minzoom, maxzoom);
  }
  ...
  Future<List<String>> getSourceIds() async {
    return (await _maplibrePlatform.getSourceIds()).whereType<String>().toList();
  }
